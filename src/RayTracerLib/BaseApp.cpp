...
bool BaseApp::IsKeyPressed(int32_t key)
{
...
bool BaseApp::Initialize()
{
	...
	_windowHandle = glfwCreateWindow(windowWidth, windowHeight,
					 "RayTracer Template", nullptr,
					 nullptr);
	...
	glfwSetWindowPos(_windowHandle, screenWidth / 2 - windowWidth / 2,
...
bool BaseApp::Load()
{
	...
	glDebugMessageCallback(
		[](GLenum source, GLenum type, GLuint, GLenum severity, GLsizei,
		   const GLchar *message, const void *) {
			if (type == GL_DEBUG_TYPE_ERROR) {
				spdlog::error(
					"GL CALLBACK: type = {}, severity = error, message = {}\n",
					type, message);
			}
		},
		nullptr);
...
void BaseApp::RenderScene([[maybe_unused]] float dt)
{
}

void BaseApp::RenderUI([[maybe_unused]] float dt)
{
}

void BaseApp::Update([[maybe_unused]] float dt)
{
}

void BaseApp::AfterCreatedUiContext()
{
}

void BaseApp::BeforeDestroyUiContext()
{
}
